...
from app.models.game_term import GameTerm, GameTermCreate, GameTermUpdate

logger = logging.getLogger(__name__)

COLLECTION_NAME = "game_terms"
...
class GameTermDAO:
    ...
    def create(self, term: GameTermCreate) -> GameTerm:
        """创建游戏圈术语"""
        term_data = {
            "term": term.term,
        ...
        return GameTerm(**term_data)

    def find_by_id(self, term_id: str) -> Optional[GameTerm]:
        """根据ID查询术语"""
    ...
    def find_by_term(self, term: str) -> Optional[GameTerm]:
        """根据术语名称查询"""
    ...
    def update(self, term_id: str, term_update: GameTermUpdate) -> Optional[GameTerm]:
        """更新术语信息"""
        from bson import ObjectId
        try:
    ...
    def update_ai_content(self, term_id: str, ai_copywriting: Optional[str] = None, ai_script: Optional[str] = None) -> Optional[GameTerm]:
    ...
    def toggle_field(self, term_id: str, field: str) -> Optional[GameTerm]:
        """切换布尔字段状态"""
        from bson import ObjectId
        try:
            oid = ObjectId(term_id)
